...
public class Car {// class must have attributes and futures.
	...
	void drive() {
		...
		System.out.println("Tesla can drive");
	}
	

	void reverse() {

		System.out.println("Tesla can reverse");

	}

	void stop() {

		System.out.println("Tesla can stop");
		System.out.println("Tesla can stop TOOOOOO");
