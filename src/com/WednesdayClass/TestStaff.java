...
public class TestStaff {
    ...
    public static void main(String[] args) {
        ...
        Professor p2 = new Professor("Arias Snow", "123 abs st", 9600, "Benz", "12/10/2010", 1234567878);
        ...
        Secretary s2 = new Secretary("More Snow", "123 abs st", 9600, "Benz", "12/10/2010", 1234567878);
