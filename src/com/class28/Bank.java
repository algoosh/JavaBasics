...
/*public interface Bank {//inside interface body we can have only undefined methods//define only behavior
	//but abstract method//no body of interface
//it 0% defined!But can have variables that has values;STATIC, PUBLIC, FINAL! cAN NOT HAVE INSTANCE MEMBERS (variables and methods)
	void hasChecking();
	void hasSavings();
	void hasCreditCard();
}                       // if you are accepting interface rules u must have all implementations
*/
package com.class28;
